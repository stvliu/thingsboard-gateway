...
class GetAcAlarmStatusResponse:
    def __init__(self, data_flag: DataFlag, number_of_inputs: int, voltage_a_status: VoltageStatus,
        ...
        print(f"初始化GetAcAlarmStatusResponse, data_flag={data_flag}, number_of_inputs={number_of_inputs}, voltage_a_status={voltage_a_status}, voltage_b_status={voltage_b_status}, voltage_c_status={voltage_c_status}, frequency_status={frequency_status}, fuse_count={fuse_count}, user_defined_params_count={user_defined_params_count}, ac_arrester_status={ac_arrester_status}, ac_comm_failure_status={ac_comm_failure_status}, ac_input_switch_status={ac_input_switch_status}, ac_output_switch_status={ac_output_switch_status}, ac_power_status={ac_power_status}")
    ...
    @classmethod
    def from_bytes(cls, data):
        print(f"从字节串{data.hex()}构建GetAcAlarmStatusResponse")
...
class GetAcConfigParamsResponse:
    def __init__(self, ac_over_voltage: float, ac_under_voltage: float):
        ...
        print(f"初始化GetAcConfigParamsResponse, ac_over_voltage={ac_over_voltage}, ac_under_voltage={ac_under_voltage}")

    def to_bytes(self):
        print(f"将GetAcConfigParamsResponse转换为字节串")  
        return struct.pack('<ff', self.ac_over_voltage, self.ac_under_voltage)

    @classmethod
    def from_bytes(cls, data):
        print(f"从字节串{data.hex()}构建GetAcConfigParamsResponse")
...
class SetAcConfigParamsRequest:
    def __init__(self, ac_over_voltage: float, ac_under_voltage: float):
        ...
        self.ac_under_voltage = ac_under_voltage  # 交流输入线/相电压下限,4字节浮点数,参数类型81H
        print(f"初始化SetAcConfigParamsRequest, ac_over_voltage={ac_over_voltage}, ac_under_voltage={ac_under_voltage}")

    def to_bytes(self):
        print(f"将SetAcConfigParamsRequest转换为字节串")
        return struct.pack('<ff', self.ac_over_voltage, self.ac_under_voltage)

    @classmethod
    def from_bytes(cls, data):
        print(f"从字节串{data.hex()}构建SetAcConfigParamsRequest")  
        ac_over_voltage, ac_under_voltage = struct.unpack('<ff', data)
        return cls(ac_over_voltage, ac_under_voltage)
...
class GetRectAnalogDataResponse:
    def __init__(self, data_flag: DataFlag, output_voltage: float, module_count: int, module_currents: List[float],
        ...
        print(f"初始化GetRectAnalogDataResponse, data_flag={data_flag}, output_voltage={output_voltage}, module_count={module_count}, module_currents={module_currents}, user_defined_params_count={user_defined_params_count}, module_current_limit={module_current_limit}, module_voltage={module_voltage}, module_temperature={module_temperature}, module_input_voltage_ab={module_input_voltage_ab}")

    def to_bytes(self):
        print(f"将GetRectAnalogDataResponse转换为字节串") 
    ...
    @classmethod
    def from_bytes(cls, data):
        print(f"从字节串{data.hex()}构建GetRectAnalogDataResponse")
...
class GetRectSwitchStatusResponse:
    def __init__(self, data_flag: DataFlag, module_count: int, module_run_status: List[SwitchStatus],
        ...
        print(f"初始化GetRectSwitchStatusResponse, data_flag={data_flag}, module_count={module_count}, module_run_status={module_run_status}, module_limit_status={module_limit_status}, module_charge_status={module_charge_status}, user_defined_params_count={user_defined_params_count}") 

    def to_bytes(self):
        print(f"将GetRectSwitchStatusResponse转换为字节串")
    ...
    @classmethod
    def from_bytes(cls, data):  
        print(f"从字节串{data.hex()}构建GetRectSwitchStatusResponse")
...
class GetRectAlarmStatusResponse:
    def __init__(self, data_flag: DataFlag, module_count: int, module_failure_status: List[AlarmStatus],
        ...
        print(f"初始化GetRectAlarmStatusResponse, data_flag={data_flag}, module_count={module_count}, module_failure_status={module_failure_status}, user_defined_params_count={user_defined_params_count}, module_comm_failure_status={module_comm_failure_status}, module_protection_status={module_protection_status}, module_fan_status={module_fan_status}")
  
    def to_bytes(self):
        print(f"将GetRectAlarmStatusResponse转换为字节串")
        data = bytearray(struct.pack('<BB', self.data_flag.value, self.module_count))  
        for i in range(self.module_count):
    ...
    @classmethod
    def from_bytes(cls, data):
        print(f"从字节串{data.hex()}构建GetRectAlarmStatusResponse") 
        data_flag, module_count = struct.unpack('<BB', data[:2])
        offset = 2
...
class ControlRectModuleRequest:
    def __init__(self, module_id: int, control_type: RectModuleControlType, control_value: int):  
        ...
        print(f"初始化ControlRectModuleRequest, module_id={module_id}, control_type={control_type}, control_value={control_value}")
 
    def to_bytes(self):  
        print(f"将ControlRectModuleRequest转换为字节串")
        return struct.pack('<BBB', self.module_id, self.control_type.value, self.control_value)
        
    @classmethod
    def from_bytes(cls, data):
        print(f"从字节串{data.hex()}构建ControlRectModuleRequest")
...
class GetDcAnalogDataResponse:
    def __init__(self, data_flag: DataFlag, dc_voltage: float, total_load_current: float, battery_group_count: int,
        ...
        print(f"初始化GetDcAnalogDataResponse, data_flag={data_flag}, dc_voltage={dc_voltage}, total_load_current={total_load_current}, battery_group_count={battery_group_count}, battery_group_1_number={battery_group_1_number}, battery_group_1_current={battery_group_1_current}, load_branch_count={load_branch_count}, load_branch_1_current={load_branch_1_current}, load_branch_2_current={load_branch_2_current}, load_branch_3_current={load_branch_3_current}, load_branch_4_current={load_branch_4_current}, user_defined_params_count={user_defined_params_count}, battery_total_current={battery_total_current}, battery_group_1_capacity={battery_group_1_capacity}, battery_group_1_voltage={battery_group_1_voltage}, battery_group_1_mid_voltage={battery_group_1_mid_voltage}, battery_group_2_mid_voltage={battery_group_2_mid_voltage}, battery_group_3_mid_voltage={battery_group_3_mid_voltage}, battery_group_4_mid_voltage={battery_group_4_mid_voltage}, battery_group_1_temperature={battery_group_1_temperature}, env_temp_1={env_temp_1}, env_temp_2={env_temp_2}, env_humidity_1={env_humidity_1}, total_load_power={total_load_power}, load_power_1={load_power_1}, load_power_2={load_power_2}, load_power_3={load_power_3}, load_power_4={load_power_4}, total_load_energy={total_load_energy}, load_energy_1={load_energy_1}, load_energy_2={load_energy_2}, load_energy_3={load_energy_3}, load_energy_4={load_energy_4}")
...
class GetDcConfigParamsResponse:
    def __init__(self, dc_over_voltage: float, dc_under_voltage: float, time_equalize_charge_enable: EnableStatus,
       ...
       print(f"初始化GetDcConfigParamsResponse, dc_over_voltage={dc_over_voltage}, dc_under_voltage={dc_under_voltage}, time_equalize_charge_enable={time_equalize_charge_enable}, time_equalize_duration={time_equalize_duration}, time_equalize_interval={time_equalize_interval}, battery_group_number={battery_group_number}, battery_over_temp={battery_over_temp}, battery_under_temp={battery_under_temp}, env_over_temp={env_over_temp}, env_under_temp={env_under_temp}, env_over_humidity={env_over_humidity}, battery_charge_current_limit={battery_charge_current_limit}, float_voltage={float_voltage}, equalize_voltage={equalize_voltage}, battery_off_voltage={battery_off_voltage}, battery_on_voltage={battery_on_voltage}, llvd1_off_voltage={llvd1_off_voltage}, llvd1_on_voltage={llvd1_on_voltage}, llvd2_off_voltage={llvd2_off_voltage}, llvd2_on_voltage={llvd2_on_voltage}, llvd3_off_voltage={llvd3_off_voltage}, llvd3_on_voltage={llvd3_on_voltage}, llvd4_off_voltage={llvd4_off_voltage}, llvd4_on_voltage={llvd4_on_voltage}, battery_capacity={battery_capacity}, battery_test_stop_voltage={battery_test_stop_voltage}, battery_temp_coeff={battery_temp_coeff}, battery_temp_center={battery_temp_center}, float_to_equalize_coeff={float_to_equalize_coeff}, equalize_to_float_coeff={equalize_to_float_coeff}, llvd1_off_time={llvd1_off_time}, llvd2_off_time={llvd2_off_time}, llvd3_off_time={llvd3_off_time}, llvd4_off_time={llvd4_off_time}, load_off_mode={load_off_mode}")
    ...
    @classmethod  
    def from_bytes(cls, data):
        print(f"从字节串{data.hex()}构建GetDcConfigParamsResponse")
...
class SetDcConfigParamsRequest:
   def __init__(self, dc_over_voltage: float, dc_under_voltage: float, time_equalize_charge_enable: EnableStatus,
                ...
                float_to_equalize_coeff: float, equalize_to_float_coeff: float, llvd1_off_time: float,
                llvd2_off_time: float, llvd3_off_time: float, llvd4_off_time: float, load_off_mode: LoadOffMode):
       self.dc_over_voltage = dc_over_voltage   # 直流过压值,4字节浮点数,参数类型80H
       self.dc_under_voltage = dc_under_voltage   # 直流欠压值,4字节浮点数,参数类型81H
       self.time_equalize_charge_enable = time_equalize_charge_enable   # 定时均充使能,1字节,参数类型C0H
       self.time_equalize_duration = time_equalize_duration    # 定时均充时间,1字节,参数类型C5H
       self.time_equalize_interval = time_equalize_interval    # 定时均充间隔,2字节,参数类型C6H
       self.battery_group_number = battery_group_number   # 电池组数,1字节,参数类型C7H  
       self.battery_over_temp = battery_over_temp    # 电池过温告警点,4字节浮点数,参数类型D4H
       self.battery_under_temp = battery_under_temp    # 电池欠温告警点,4字节浮点数,参数类型D5H
       self.env_over_temp = env_over_temp   # 环境过温告警点,4字节浮点数,参数类型D6H
       self.env_under_temp = env_under_temp   # 环境欠温告警点,4字节浮点数,参数类型D7H
       self.env_over_humidity = env_over_humidity    # 环境过湿告警点,4字节浮点数,参数类型D8H
       self.battery_charge_current_limit = battery_charge_current_limit   # 电池充电限流点,4字节浮点数,参数类型DAH  
       self.float_voltage = float_voltage    # 浮充电压,4字节浮点数,参数类型DBH
       self.equalize_voltage = equalize_voltage   # 均充电压,4字节浮点数,参数类型DCH
       self.battery_off_voltage = battery_off_voltage   # 电池下电电压,4字节浮点数,参数类型DDH
       self.battery_on_voltage = battery_on_voltage    # 电池上电电压,4字节浮点数,参数类型DEH
       self.llvd1_off_voltage = llvd1_off_voltage   # LLVD1下电电压,4字节浮点数,参数类型DFH
       self.llvd1_on_voltage = llvd1_on_voltage    # LLVD1上电电压,4字节浮点数,参数类型E0H
       self.llvd2_off_voltage = llvd2_off_voltage   # LLVD2下电电压,4字节浮点数,参数类型E1H
       self.llvd2_on_voltage = llvd2_on_voltage    # LLVD2上电电压,4字节浮点数,参数类型E2H  
       self.llvd3_off_voltage = llvd3_off_voltage   # LLVD3下电电压,4字节浮点数,参数类型E3H
       self.llvd3_on_voltage = llvd3_on_voltage    # LLVD3上电电压,4字节浮点数,参数类型E4H
       self.llvd4_off_voltage = llvd4_off_voltage   # LLVD4下电电压,4字节浮点数,参数类型E5H
       self.llvd4_on_voltage = llvd4_on_voltage    # LLVD4上电电压,4字节浮点数,参数类型E6H
       self.battery_capacity = battery_capacity   # 每组电池额定容量,4字节浮点数,参数类型E7H
       self.battery_test_stop_voltage = battery_test_stop_voltage   # 电池测试终止电压,4字节浮点数,参数类型E8H
       self.battery_temp_coeff = battery_temp_coeff   # 电池组温补系数,4字节浮点数,参数类型EAH
       self.battery_temp_center = battery_temp_center   # 电池温补中心点,4字节浮点数,参数类型EBH  
       self.float_to_equalize_coeff = float_to_equalize_coeff   # 浮充转均充系数,4字节浮点数,参数类型ECH
       self.equalize_to_float_coeff = equalize_to_float_coeff   # 均充转浮充系数,4字节浮点数,参数类型EDH
       self.llvd1_off_time = llvd1_off_time    # LLVD1下电时间,4字节浮点数,参数类型EEH
       self.llvd2_off_time = llvd2_off_time    # LLVD2下电时间,4字节浮点数,参数类型EFH
       self.llvd3_off_time = llvd3_off_time    # LLVD3下电时间,4字节浮点数,参数类型F0H
       self.llvd4_off_time = llvd4_off_time    # LLVD4下电时间,4字节浮点数,参数类型F1H
       self.load_off_mode = load_off_mode     # 负载下电模式,1字节,参数类型F2H
       print(f"初始化SetDcConfigParamsRequest, dc_over_voltage={dc_over_voltage}, dc_under_voltage={dc_under_voltage}, time_equalize_charge_enable={time_equalize_charge_enable}, time_equalize_duration={time_equalize_duration}, time_equalize_interval={time_equalize_interval}, battery_group_number={battery_group_number}, battery_over_temp={battery_over_temp}, battery_under_temp={battery_under_temp}, env_over_temp={env_over_temp}, env_under_temp={env_under_temp}, env_over_humidity={env_over_humidity}, battery_charge_current_limit={battery_charge_current_limit}, float_voltage={float_voltage}, equalize_voltage={equalize_voltage}, battery_off_voltage={battery_off_voltage}, battery_on_voltage={battery_on_voltage}, llvd1_off_voltage={llvd1_off_voltage}, llvd1_on_voltage={llvd1_on_voltage}, llvd2_off_voltage={llvd2_off_voltage}, llvd2_on_voltage={llvd2_on_voltage}, llvd3_off_voltage={llvd3_off_voltage}, llvd3_on_voltage={llvd3_on_voltage}, llvd4_off_voltage={llvd4_off_voltage}, llvd4_on_voltage={llvd4_on_voltage}, battery_capacity={battery_capacity}, battery_test_stop_voltage={battery_test_stop_voltage}, battery_temp_coeff={battery_temp_coeff}, battery_temp_center={battery_temp_center}, float_to_equalize_coeff={float_to_equalize_coeff}, equalize_to_float_coeff={equalize_to_float_coeff}, llvd1_off_time={llvd1_off_time}, llvd2_off_time={llvd2_off_time}, llvd3_off_time={llvd3_off_time}, llvd4_off_time={llvd4_off_time}, load_off_mode={load_off_mode}")

   def to_bytes(self):
       print(f"将SetDcConfigParamsRequest转换为字节串")
       data = bytearray(struct.pack('<ff', self.dc_over_voltage, self.dc_under_voltage))
       data.extend(struct.pack('<BHHBBBBB', self.time_equalize_charge_enable.value, self.time_equalize_duration,
                               self.time_equalize_interval, self.battery_group_number, self.battery_over_temp,
                               self.battery_under_temp, self.env_over_temp, self.env_under_temp))
   ...
   @classmethod
   def from_bytes(cls, data):  
       print(f"从字节串{data.hex()}构建SetDcConfigParamsRequest")
       (dc_over_voltage, dc_under_voltage, time_equalize_charge_enable, time_equalize_duration,
        time_equalize_interval, battery_group_number, battery_over_temp, battery_under_temp,
        env_over_temp, env_under_temp, env_over_humidity, battery_charge_current_limit,
        float_voltage, equalize_voltage, battery_off_voltage, battery_on_voltage, llvd1_off_voltage,
...
class SetSystemControlStateRequest:  
   def __init__(self, state: SystemControlState):
       ...
       print(f"初始化SetSystemControlStateRequest, state={state}") 
   
   def to_bytes(self):
       print(f"将SetSystemControlStateRequest转换为字节串")
       return struct.pack('<B', self.state.value)
       
   @classmethod
   def from_bytes(cls, data):
       print(f"从字节串{data.hex()}构建SetSystemControlStateRequest") 
...
class GetSystemControlStateResponse:
   def __init__(self, state: SystemControlState):  
       self.state = state   # 系统控制状态,1字节
       print(f"初始化GetSystemControlStateResponse, state={state}")
   
   def to_bytes(self):
       print(f"将GetSystemControlStateResponse转换为字节串")
       return struct.pack('<B', self.state.value)
       
   @classmethod
   def from_bytes(cls, data):
       print(f"从字节串{data.hex()}构建GetSystemControlStateResponse")
       state, = struct.unpack('<B', data)  
       return cls(SystemControlState(state))
...
class SetAlarmSoundEnableRequest:
   def __init__(self, enable: EnableStatus):
       ...
       print(f"初始化SetAlarmSoundEnableRequest, enable={enable}")
   
   def to_bytes(self):
       print(f"将SetAlarmSoundEnableRequest转换为字节串")
       return struct.pack('<B', self.enable.value)
       
   @classmethod  
   def from_bytes(cls, data):
       print(f"从字节串{data.hex()}构建SetAlarmSoundEnableRequest")
...
class GetEnergyParamsResponse:
   def __init__(self, energy_saving: EnableStatus, min_working_modules: int, module_switch_cycle: int,
       ...
       print(f"初始化GetEnergyParamsResponse, energy_saving={energy_saving}, min_working_modules={min_working_modules}, module_switch_cycle={module_switch_cycle}, module_best_efficiency_point={module_best_efficiency_point}, module_redundancy_point={module_redundancy_point}")
   
   def to_bytes(self):
       print(f"将GetEnergyParamsResponse转换为字节串")  
   ...
   @classmethod
   def from_bytes(cls, data):
       print(f"从字节串{data.hex()}构建GetEnergyParamsResponse")
...
class SetEnergyParamsRequest:
   def __init__(self, energy_saving: EnableStatus, min_working_modules: int, module_switch_cycle: int,
                module_best_efficiency_point: int, module_redundancy_point: int):  
       self.energy_saving = energy_saving   # 节能允许,1字节,参数类型E1H,0:使能,1:禁止
       self.min_working_modules = min_working_modules   # 最小工作模块数,1字节,参数类型E2H
       self.module_switch_cycle = module_switch_cycle   # 模块循环开关周期,2字节,参数类型E3H
       self.module_best_efficiency_point = module_best_efficiency_point   # 模块最佳效率点,1字节,参数类型E4H
       self.module_redundancy_point = module_redundancy_point   # 模块冗余点,1字节,参数类型E5H
       print(f"初始化SetEnergyParamsRequest, energy_saving={energy_saving}, min_working_modules={min_working_modules}, module_switch_cycle={module_switch_cycle}, module_best_efficiency_point={module_best_efficiency_point}, module_redundancy_point={module_redundancy_point}")
   
   def to_bytes(self):  
       print(f"将SetEnergyParamsRequest转换为字节串")
       return struct.pack('<BBHBB', self.energy_saving.value, self.min_working_modules, self.module_switch_cycle,
                          self.module_best_efficiency_point, self.module_redundancy_point)
       
   @classmethod
   def from_bytes(cls, data):
       print(f"从字节串{data.hex()}构建SetEnergyParamsRequest")
       (energy_saving, min_working_modules, module_switch_cycle, 
        module_best_efficiency_point, module_redundancy_point) = struct.unpack('<BBHBB', data)
       return cls(EnableStatus(energy_saving), min_working_modules, module_switch_cycle,
                  module_best_efficiency_point, module_redundancy_point)  
...
class SystemControlRequest:
   def __init__(self, control_type: SystemControlType):
       ...
       print(f"初始化SystemControlRequest, control_type={control_type}")
   
   def to_bytes(self):
       print(f"将SystemControlRequest转换为字节串")  
